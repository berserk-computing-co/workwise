...
@Module({
  ...
  providers: [PipelineRunner, JobProgressService, PipelineJobService, CancellationService],
  exports: [TypeOrmModule, PipelineRunner, PipelineJobService, CancellationService],
})
