...
function Step4Summary({
  ...
  return (
    <div className="space-y-3">
      <BotCard
        title="Ready to build your estimate."
        subtitle="We'll break this into scoped sections, pull local pricing, and generate itemized line items with options to review. Takes about 30 seconds."
      />
